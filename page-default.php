...
?>
					<table class="table table-bordered table-striped">
						...
						<tr>
							...
							<td><?php echo html($peer['version'] . ' ' . $peer['subver'])?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo (format_time($peer['conntime']))?></td>
						</tr>
						<tr>
							<th>Send: Last / Size</th>
							<td><?php echo (format_time($peer['lastsend']) . ' / ' . number_format($peer['bytessent']/(1024*1024), 2) . " MB")?></td>
						</tr>
						<tr>
							<th>Recv: Last / Size</th>
							<td><?php echo (format_time($peer['lastrecv']) . ' / ' . number_format($peer['bytesrecv']/(1024*1024), 2) . " MB")?></td>
						</tr>
					</table>	
<?php
		}
